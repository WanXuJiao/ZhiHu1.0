 ...
 */
public class ThankfulAdapter extends BaseAdapter {
    @Override
    public int getCount() {
        return GlobalDatas.mThankfulIcons.length;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        iv_notice_icon.setImageResource(GlobalDatas.mThankfulIcons[position]);
        tv_notice_givenname.setText(GlobalDatas.mThankfulGivenNames[position]);
        tv_notice_title.setText(GlobalDatas.mThankfulTitles[position]);
        return view;
    }
}
