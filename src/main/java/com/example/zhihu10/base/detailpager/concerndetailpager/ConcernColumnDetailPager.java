 ...
 */
public class ConcernColumnDetailPager extends BaseDetailPager {

    private ListView lv_detailpager;
    public ConcernColumnDetailPager(Activity activity) {
        super(activity);
    }
    ...
    public View initView() {
        ...
        lv_detailpager.setAdapter(new ConcernCollectAdapter(R.layout.item_concern_column_listview));
        return view;
    }
