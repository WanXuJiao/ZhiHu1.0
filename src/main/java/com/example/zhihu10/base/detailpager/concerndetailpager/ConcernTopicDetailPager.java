 ...
 */
public class ConcernTopicDetailPager extends BaseDetailPager {

    private ListView lv_detailpager;
    public ConcernTopicDetailPager(Activity activity) {
        super(activity);
    }
    ...
    public View initView() {
        ...
        lv_detailpager.setAdapter(new ConcernCollectAdapter(R.layout.item_concern_topic_listview));
        return view;
    }
