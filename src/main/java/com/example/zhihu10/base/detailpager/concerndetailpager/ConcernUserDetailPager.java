 ...
 */
public class ConcernUserDetailPager extends BaseDetailPager {

    private ListView lv_detailpager;
    public ConcernUserDetailPager(Activity activity) {
        super(activity);
    }
    ...
    public View initView() {
        ...
        lv_detailpager.setAdapter(new ConcernCollectAdapter(R.layout.item_concern_user_listview));
        return view;
    }
